...
with open('local/user_data.csv', 'r', encoding='UTF-8-SIG') as f:
...
with open('local/poster.csv', 'r', encoding='UTF-8-SIG') as f:
    post_dic ={}
...
with open('local/user_dic.json', 'w', encoding='UTF-8-SIG') as f: json.dump(user_dic, f)
with open('local/post_dic.json', 'w', encoding='UTF-8-SIG') as f: json.dump(post_dic, f)